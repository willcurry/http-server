...
public class ServerTests {
    ...
    public void responseIsStatus200WhenGET() throws IOException {
        before("GET / HTTP/1.1");
        assertThat(Util.makeString(output.getAllBytes()), containsString("HTTP/1.1 200 OK"));
    }
    ...
    public void responseIsStatus404WhenUnknownURI() throws IOException {
        ...
        assertThat(Util.makeString(output.getAllBytes()), containsString("HTTP/1.1 404 Not Found"));
    }
    ...
    public void whenURIIsMethodOptionsTheHeaderAllowsCorrectMethods() throws IOException {
        ...
        assertThat(Util.makeString(output.getAllBytes()), containsString("ALLOW: GET,HEAD,POST,OPTIONS,PUT"));
    }

    @Test
    public void whenURIIsMethodOptions2TheHeaderAllowsCorrectMethods() throws IOException {
        before("GET /method_options2 HTTP/1.1");
        assertThat(Util.makeString(output.getAllBytes()), containsString("ALLOW: GET,OPTIONS"));
    }

    @Test
    public void responseIsStatus302WhenURIIsRedirect() throws IOException {
        before("GET /redirect HTTP/1.1");
        assertThat(Util.makeString(output.getAllBytes()), containsString("HTTP/1.1 302 Found"));
    }

    @Test
    public void locationIsSetToHomeWhenURIIsRedirect() throws IOException {
        before("GET /redirect HTTP/1.1");
        assertThat(Util.makeString(output.getAllBytes()), containsString("Location: /"));
    }
}
