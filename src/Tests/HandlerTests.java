...
public class HandlerTests {
    ...
    public void before() {
        ...
        responseFinder = new ResponseFinder(new FakeRouter(storage));
    }

    @Test
    public void findsDefaultPageCorrectly() throws IOException {
        FakeRequest fakeRequest = TestUtil.createFakeRequest("GET", "/", "");
        assertThat(TestUtil.makeString(responseFinder.find(fakeRequest).asByteArray()), containsString("200 OK"));
    }
    ...
    public void findsMethodOptionsCorrectly() throws IOException {
        ...
        assertThat(TestUtil.makeString(responseFinder.find(fakeRequest).asByteArray()), containsString("ALLOW: GET,HEAD,POST,OPTIONS,PUT"));
    }
    ...
    public void findsMethodOptions2Correctly() throws IOException {
        ...
        assertThat(TestUtil.makeString(responseFinder.find(fakeRequest).asByteArray()), containsString("ALLOW: GET,OPTIONS"));
    }

    @Test
    public void findsRedirectCorrectly() throws IOException {
        FakeRequest fakeRequest = TestUtil.createFakeRequest("GET", "/redirect", "");
        assertThat(TestUtil.makeString(responseFinder.find(fakeRequest).asByteArray()), containsString("302 Found"));
    }
    ...
    public void findsPatchContentCorrectly() throws IOException {
        ...
        assertThat(TestUtil.makeString(responseFinder.find(fakeRequest).asByteArray()), containsString("204"));
    }

    @Test
    public void findsFourOhFourCorrectly() throws IOException {
        FakeRequest fakeRequest = TestUtil.createFakeRequest("GET", "/404", "");
        assertThat(TestUtil.makeString(responseFinder.find(fakeRequest).asByteArray()), containsString("404 Not Found"));
    }

    @Test
    public void findsFile1Correctly() throws IOException {
        FakeRequest fakeRequest = TestUtil.createFakeRequest("POST", "/file1", "");
        assertThat(TestUtil.makeString(responseFinder.find(fakeRequest).asByteArray()), containsString("405"));
    }
